...
exports.findById = function (id) {
    return Repository.User.findById(id);
};
...
exports.findOne = function (value, criteria = {}) {
    const query = Repository.User.findOne(value);
...
exports.update = function (id, updatedUser) {
    return Repository.tx(Repository.User.model, async txUser => {
        ...
        // this patch need to check for password and assert rules just like when its created
