...
exports.list = {
    ...
    pre: [AuthorizationController.authorize(Actions.READ)],
...
exports.create = {
    ...
    pre: [AuthorizationController.authorize(Actions.CREATE)],
...
exports.update = {
    ...
    pre: [AuthorizationController.authorize(Actions.UPDATE)],
...
exports.remove = {
    ...
    pre: [AuthorizationController.authorize(Actions.DELETE)],
